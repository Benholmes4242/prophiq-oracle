-- Brief DD: TRIAL_CAP reduction 100 -> 40 to match updated Pro tier daily cap.
--
-- Updates the single source of truth get_user_quota_today RPC so that
-- trialing users receive 40 forecasts/day (same as active Pro) instead of 100.
